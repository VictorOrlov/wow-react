  ...
  return[
    {
      ...
      info: <span className="itemInfo">
        <h2>Кузнечное дело <Image src = {require ('../../image/Profs/pngICONS/Blacksmith.png'  )} /></h2>
      ...
      advantage: <span className="itemAdvantage">
        ...
        <p><span>Оружие и доспехи</span><br/>
      ...
      info: <span className="itemInfo">
        <h2>Наложение чар <Image src = {require ('../../image/Profs/pngICONS/Enchantment.png'  )} /></h2>
      ...
      advantage: <span className="itemAdvantage">
        ...
        <p><span>Жезлы и аксессуары</span><br/>
      ...
      info: <span className="itemInfo">
        <h2>Инженерное дело <Image src = {require ('../../image/Profs/pngICONS/Engineering.png'  )} /></h2>
      ...
      info: <span className="itemInfo">
        <h2>Травничество <Image src = {require ('../../image/Profs/pngICONS/Herbalism.png'  )} /></h2>
      ...
      advantage: <span className="itemAdvantage">
        ...
        <p><span>Алхимия</span><br/>
        Алхимики используют травы для создания странных магических зелий, которые могут исцелять, 
        наделять силой и вызывать наложение разнообразных положительных эффектов.</p>
        
        <p><span>Начертание</span><br/>
        Начертатели создают символы, улучшающие способности 
        героев и дающие им новые возможности.</p>
      </span>
    }, {
      id: "Incsription",
      name: "Начертание",
      ...
      info: <span className="itemInfo">
        <h2>Начертание <Image src = {require ('../../image/Profs/pngICONS/Incsription.png'  )} /></h2>
      ...
      advantage: <span className="itemAdvantage">
        ...
        <p><span>Усиление</span><br/>
        Начертатели могут усиливать некоторые предметы своей экипировки 
        магическими письменами.</p><br/><br/><br/>

        <h4>Связанные профессии</h4><hr/>
        <p><span>Травничество</span><br/>
        Травники аккуратно собирают полезные травы, растущие по всему миру.</p>
      </span>
    }, {
      id: "Jevelcrafting",
      name: "Ювелирное дело",
      ...
      info: <span className="itemInfo">
        <h2>Ювелирное дело <Image src = {require ('../../image/Profs/pngICONS/Jevelcrafting.png'  )} /></h2>
      ...
      advantage: <span className="itemAdvantage">
        <h4>Преимущества</h4><hr/>
        <p><span>Резьба по камню</span><br/>
        ...
        <p><span>Эксклюзивные драгоценные камни</span><br/>
      ...
      info: <span className="itemInfo">
        <h2>Кожевничество <Image src = {require ('../../image/Profs/pngICONS/Leather.png'  )} /></h2>
      ...
      advantage: <span className="itemAdvantage">
        <h4>Преимущества</h4><hr/>
        <p><span>Доспехи</span><br/>
        Кожаные и кольчужные доспехи и плащи.</p>
        <p><span>Накладки</span><br/>
        ...
        <p><span>Сумки</span><br/>
        В сумках можно унести больше предметов.</p>
        <p><span>Особые доспехи</span><br/>
        Кожевники могут создавать особые доспехи лично для себя.</p><br/><br/><br/>

        <h4>Связанные профессии</h4><hr/>

        <p><span>Снятие шкур</span><br/>
        Мастера снятия шкур следят, чтобы ничто не пропало зря.</p>
      ...
      style: ("butMining but"),
      info: <span className="itemInfo">
      <h2>Горное дело <Image src = {require ('../../image/Profs/pngICONS/Mining.png'  )} /></h2>
      ...
      advantage: <span className="itemAdvantage">
        ...
        <p><span>«Крепость»</span><br/>
        Самые опытные горняки приобретают способность «Крепость», 
        которая навсегда повышает их выносливость.</p><br/><br/><br/>

        <h4>Связанные профессии</h4><hr/>

        <p><span>Кузнечное дело</span><br/>
        С помощью молота и наковальни мастеровитые кузнецы могут создавать смертельное оружие, кольчугу и латные доспехи, а также другие, особые предметы.</p>

        <p><span>Инженерное дело</span><br/>
        В своей непревзойденной изобретательности инженеры умеют создавать множество полезных, а порой совершенно невероятных вещей.</p>

        <p><span>Ювелирное дело</span><br/>
        Ювелиры способны открывать миру удивительную силу драгоценных камней, создавать могущественные украшения и аксессуары.</p>
      ...
      info: <span className="itemInfo">
      <h2>Снятие шкур <Image src = {require ('../../image/Profs/pngICONS/Skinning.png'  )} /></h2>
      ...
      advantage: <span className="itemAdvantage">
        ...
        <p><span>«Знаток анатомии»</span><br/>
        ...
        <p><span>Кожевничество</span><br/>
        Кожевники создают разнообразные полезные вещи из грубой, шершавой и жесткой кожи.</p>

        <p><span>Портняжное дело</span><br/>
        Портные превращают обычную ткань в произведение искусства: тканевые доспехи и мантии, рубашки, сумки и прочее.</p>
      </span>
    }, {
      id: "Tailloring",
      ...
      info: <span className="itemInfo">
        <h2>Портняжное дело <Image src = {require ('../../image/Profs/pngICONS/Tailloring.png'  )} /></h2>
      ...
      info: <span className="itemInfo">
        <h2>Алхимия <Image src = {require ('../../image/Profs/pngICONS/Alchemy.png'  )} /></h2>
      ...
      advantage: <span className="itemAdvantage">
        ...
        <p><span>Эликсиры и настои</span><br/>
