		...
		return(
			...
			<Grid className="wrappClassesDiv">
				...
				<Col md={4} className="heroDesc">
					...
					<p>Несколько столетий назад пандарены были порабощены империей 
					...
					прекрасно подготовлены к тому, чтобы сбросить иго поработителей. </p><br/>

					<h4>Описание</h4>
					<p>Вне зависимости от предпочитаемого стиля монахи в бою полагаются 
					...
					союзников и наносят урон противникам. </p><br/>
				...
				<Col md={4} className="paperDesc pabg_monk">
					<h3>Особенности</h3>
					<span>
						<h4>Ближний бой</h4>
						<p>
