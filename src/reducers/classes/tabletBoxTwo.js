...
export default function() {
  return[
    {  id: "tablet_paladin", 
      ...
      img: <Image src = {require ('../../image/ClassesTablet/paladintablet.jpg')} />, 
      caption: 'Паладин',
      ...
      id: "tablet_rogue", 
      link: '/classes/rogue', 
      img: <Image src = {require ('../../image/ClassesTablet/roguetablet.jpg')} />,
      caption: 'Разбойник', 
      ...
      img: <Image src = {require ('../../image/ClassesTablet/deathknighttablet.jpg')} />,
