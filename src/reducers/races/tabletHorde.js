...
export default function() {
  return[
    {  id: "orc", 
      link: ' ', 
      img: <Image src = {require ('../../image/RacesTablet/orc.jpg')} />, 
      caption: 'Орки',
