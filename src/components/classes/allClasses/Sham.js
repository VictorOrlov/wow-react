    ...
    return(
      ...
      <Grid className="wrappClassesDiv">
        ...
        <Col md={4} className="heroDesc">
          ...
          <p>Шаманы — наставники в духовных практиках, идущих не от 
          ...
          <h4>Описание</h4>
          <p>В бою шаман ставит на землю контролирующие и наносящие урон 
        ...
        <Col md={4} className="paperDesc pabg_sham">
          <h3>Особенности</h3>
          <span>
            <h4>Лечение </h4>
            <p>
